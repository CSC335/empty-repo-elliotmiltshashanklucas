...
public class GameTest {
	...
	/*
	 * public void setMatchingCards(boolean matching) { List<Card> testCards = new
	 * ArrayList<>(); if(matching){ testCards.add(new Card("match1"));
	 * testCards.add(new Card("match1")); }else { testCards.add(new Card("match2"));
	 * testCards.add(new Card("match3")); } }
	 */
	@Test
	public void testGuessCard1() {
		Game game = new GameTestable(4, 3, 2, 2, testTheme);
		game.setCards(Arrays.asList(new Card("match1"), new Card("match1"), new Card("match2"), new Card("match3")));
		// First match
		game.guessCard(0, 0);
