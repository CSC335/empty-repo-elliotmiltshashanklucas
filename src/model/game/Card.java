...
public class Card {
	...
	/**
	 * Compares this Card object to the specified object. The result is true if and
	 * only if the argument is not null and is a Card object with the same image as
	 * this object.
	 *
	 * @param o - the object to compare this Card against
	 * @return true if the given object represents a Card equivalent to this card,
	 *         false otherwise
	 */
	@Override
	...
	/**
	 * Flips the card. Notifies the cardview observer after flipping the card.
	 */
